...
namespace RPGMasterTools.Source.View.Combat
{
    ...
    public partial class ViewCombatPanelDialogHeal : UserControl
    {
        // -- CONST -----------------------------------------------------
        ...
        public ViewCombatPanelDialogHeal()
        {
            InitializeComponent();
        }
        ...
        {
            this._value = Convert.ToInt32(txtHeal.Text);
        }
